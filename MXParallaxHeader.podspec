...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/ngochiencse/MXParallaxHeader.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Hien Pham' => 'ngochiencse@gmail.com' }
  s.source           = { :git => 'https://github.com/ngochiencse/MXParallaxHeader.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '10.0'
  s.swift_version = '5.0'

  s.source_files = 'MXParallaxHeader/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MXParallaxHeader' => ['MXParallaxHeader/Assets/*.png']
  # }
