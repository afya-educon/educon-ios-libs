...
public protocol MXParallaxHeaderDelegate: AnyObject {
    /**
...
open class MXParallaxHeader: NSObject {
    /**
     ...
     */
    public weak var delegate: MXParallaxHeaderDelegate?
