//
//  MXScrollViewDelegateForwarder.swift
//  MXParallaxHeader
//
...
@objc class MXScrollViewDelegateForwarder: NSObject, MXScrollViewDelegate {
    
    @objc weak var delegate: MXScrollViewDelegate?
    @objc weak var scrollView: MXScrollView!
    
    init(scrollView: MXScrollView) {
        self.scrollView = scrollView
    }
    
    @objc public func scrollViewShouldScroll(_ scrollView: MXScrollView, with subView: UIScrollView) -> Bool {
